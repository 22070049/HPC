...
incident_fields = FILTER police_data BY $0 MATCHES '.*ROBBERY.*';
inc_robbery_group = GROUP incident_fields ALL;
inc_robbery_count = FOREACH inc_robbery_group GENERATE COUNT(incident_fields );
DUMP inc_robbery_count;